...
fontawesome.library.add(faCheck, faTimes, faPlus, faTrashAlt)
                        ...
                        { editable &&
                            <div className={`org-node-btns ${btnsClassName}`} style={btnsStyle}>
                                ...
                                {(node.managerId !== null || (node.managerId === null && rootEditable)) &&
                                    //<FontAwesomeIcon icon="pencil-alt" className="icon" onClick={this.showNode} />
                                    <FontAwesomeIcon icon={faFileAlt}  className="icon" onClick={this.showNode} />
